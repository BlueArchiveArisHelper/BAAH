class ButtonName:
    ...
    BUTTON_GRAND_ASSAULT_LOBBY = "BUTTON_GRAND_ASSAULT_LOBBY"
    ...
    # 最终篇按钮
    BUTTON_MAIN_STORY_FINAL = "BUTTON_MAIN_STORY_FINAL"
    # 从最终篇回到第一部主线的按钮
    BUTTON_MAIN_STORY_FINAL_BACK = "BUTTON_MAIN_STORY_FINAL_BACK"
    ...
    # 弃用，改为使用 BUTTON_EVENT_QUEST_SELLECTED
